...
export const GRID_CONFIG = {
  ...
  NUMBER_MOVEMENT_BASE_SPEED: 0.05, // px/s how fast the number moves
  CELL_INNER_BOUND: 20, // px within how much pixels from the edge of the cell the number can move
  POINTER_INFLUENCE_RADIUS: 100, // px the radius within which the pointer can influence the number
